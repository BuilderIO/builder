...
it('Hello', () => {
  const output = contentToLiquid(exampleContent, 'page');
  if (LOG) {
    console.log('liquid\n', output.html);
  }
...
const exampleContent: any = {
  ownerId: 'undefined',
  lastUpdateBy: null,
  createdDate: 1565800142621,
  id: '14f4f06c6e7b4725abb3907ccc458ebf',
  '@version': 3,
  name: '',
  modelId: 'e8c5f6de360e44f789b69b58747f9627',
  published: 'draft',
  priority: 0,
  query: [],
  data: {
    blocks: [
      {
        ...
        id: 'builder-9c660eec3a084703acfd457a5f46bec0',
        layerLocked: false,
        groupLocked: false,
        component: {
          name: 'Columns',
                ...
                blocks: [
                  {
                    ...
                    id: 'builder-b6a0a9174cd94d48b555e03f28ebb536',
                    layerLocked: false,
                    groupLocked: false,
                    component: {
                      name: 'Image',
                  ...
                  },
                  {
                    ...
                    id: 'builder-6dc1308248be46e18b58ad4c623916d8',
                    layerLocked: false,
                    groupLocked: false,
                    component: {
                      name: 'Text',
                ...
                blocks: [
                  {
                    ...
                    id: 'builder-a8fe67f4bed845a38528c106f08d9b45',
                    layerLocked: false,
                    groupLocked: false,
                    component: {
                      name: 'Image',
