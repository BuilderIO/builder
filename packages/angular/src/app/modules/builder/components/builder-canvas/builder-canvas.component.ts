...
@Component({
  ...
  styleUrls: ['./builder-canvas.component.css'],
...
export class BuilderCanvasComponent implements OnInit {
  ...
  @Input()
  set animations(animations: any[]) {
    // TODO: unbind existing if they exist
    // if (animations && Builder.isBrowser) {
    //   Builder.nextTick(() => {
    //     Builder.animator.bindAnimations(animations);
    //   });
    // }
  }
