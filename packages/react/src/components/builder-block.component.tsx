...
> {
  ...
  UNSAFE_componentWillUpdate(prevProps: BuilderBlockProps) {
    if (Builder.isEditing && prevProps.block !== this.props.block) {
      blocksMap[this.props.block.id!] = this.props.block;
    }
  }
