export const CONTENT_WITHOUT_SYMBOLS = {
    ...
    blocks: [
      ...
      },
      {
        ...
        responsiveStyles: {
          ...
          medium: { display: 'flex', color: 'rgb(0, 255, 6)' },
          small: { color: 'rgb(0, 255, 255)' },
        },
      },
      {
        '@type': '@builder.io/sdk:Element',
  ...
  published: 'published',
  query: [
    { '@type': '@builder.io/core:Query', operator: 'is', property: 'urlPath', value: '/symbols' },
  ],
  testRatio: 1,
  variations: {},
...
export const FIRST_SYMBOL_CONTENT = {
                ...
                blocks: [
                  {
                    ...
                    component: {
                      ...
                      options: {
                        ...
                        fitContent: true,
                        aspectRatio: 0.7041,
                        sizes: '(max-width: 638px) 100vw, (max-width: 998px) 100vw, 42vw',
                      },
                    },
                    responsiveStyles: {
                      large: {
                    ...
                    children: [
                      {
                        ...
                        component: { name: 'Text', options: { text: '<p>Title of image</p>' } },
                        responsiveStyles: {
                          large: {
                            display: 'flex',
                            flexDirection: 'column',
                      ...
                      },
                      {
                        ...
                        component: {
                          name: 'Text',
                          options: { text: '<p>Description of image: </p>' },
                        },
                        responsiveStyles: {
                          large: {
                            display: 'flex',
                      ...
                      },
                      {
                        ...
                        component: { name: 'Text', options: { text: '<p>Author of image</p>' } },
                        responsiveStyles: {
                          large: {
                            display: 'flex',
                            flexDirection: 'column',
...
export const SECOND_SYMBOL_CONTENT = {
  createdDate: 1647468296291,
  screenshot:
    'https://cdn.builder.io/api/v1/image/assets%2Ff1a790f8c3204b3b8c5c1795aeac4660%2F72d2ff7ac19549d798b830b2c9d9f3c4',
  createdBy: 'OcOewqA7uqVVlVfqY453F8vgcc33',
...
export const CONTENT = CONTENT_WITHOUT_SYMBOLS;
// export const CONTENT2 = {
//   ...CONTENT_WITHOUT_SYMBOLS,
//   data: {
//     ...CONTENT_WITHOUT_SYMBOLS.data,
//     blocks: [
//       CONTENT_WITHOUT_SYMBOLS.data.blocks[0],
//       {
//         ...CONTENT_WITHOUT_SYMBOLS.data.blocks[1],
//         component: {
//           ...CONTENT_WITHOUT_SYMBOLS.data.blocks[1].component,
//           options: {
//             ...CONTENT_WITHOUT_SYMBOLS.data.blocks[1].component.options,
//             symbol: {
//               ...CONTENT_WITHOUT_SYMBOLS.data.blocks[1].component.options.symbol,
//               content: FIRST_SYMBOL_CONTENT,
//             },
//           },
//         },
//       },
//       {
//         ...CONTENT_WITHOUT_SYMBOLS.data.blocks[2],
//         component: {
//           ...CONTENT_WITHOUT_SYMBOLS.data.blocks[2].component,
//           options: {
//             ...CONTENT_WITHOUT_SYMBOLS.data.blocks[2].component.options,
//             symbol: {
//               ...CONTENT_WITHOUT_SYMBOLS.data.blocks[2].component.options.symbol,
//               content: SECOND_SYMBOL_CONTENT,
//             },
//           },
//         },
//       },
