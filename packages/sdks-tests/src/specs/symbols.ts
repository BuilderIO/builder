 ...
 * - block[2] is a LOCAL symbol (global: undefined, no ownerId override)
 */
export const CONTENT_WITH_GLOBAL_SYMBOL = (() => {
  ...
  // Explicitly mark the second symbol as non-global
  clone.data.blocks[2].component.options.symbol.global = undefined;
  return clone;
})();
