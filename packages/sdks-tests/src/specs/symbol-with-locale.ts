export const CONTENT = {
  ...
  'folders': [],
  'data': {
    'inputs': [], 'themeId': false, 'title': 'symbol with locale', 'blocks': [{
      ...
      'component': {
        'name': 'Symbol', 'options': {
          'symbol': {
            'entry': 'e2a166f7d9544ed9ade283abf9491af3', 'model': 'symbol', 'data': {},
          }
        }
      },
      'responsiveStyles': {
    ...
    }], 'url': '/symbol-with-locale', 'state': { 'deviceSize': 'large', 'location': { 'path': '', 'query': {} } }
  },
...
export const FRENCH_TEXT_SYMBOL = {
  ...
  'data': {
    'blocks': [{
      ...
      'component': {
        'name': 'Text',
        'options': { 'text': '<span style="display: block;" class="builder-paragraph">French text</span>' }
      },
      'responsiveStyles': {
        'large': {
          'display': 'flex',
  ...
  'query': [],
  'published': 'published',
  'screenshot': 'https://cdn.builder.io/api/v1/image/assets%2Ff1a790f8c3204b3b8c5c1795aeac4660%2F2072bf01f23f4d929d2f459fc900e61c',
