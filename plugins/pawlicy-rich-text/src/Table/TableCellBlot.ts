...
class TableCell extends ContainBlot {
  ...
  optimize(context: Object) {
    ...
    // console.log('td optimization', this, parent.statics.blotName)
    if (parent != null) {
      if (parent.statics.blotName === 'td') {
        ...
        // console.log('td optimization', parent.statics.blotName, this.domNode.getAttribute('table_id'), this.domNode.getAttribute('data-row-id'))
        ...
        const tbody = Parchment.create('tbody', this.domNode.getAttribute('table_id'))
