...
This example demonstrates i18n internationalization with Next.js and localization techniques with Builder.io
...
2. Create a corresponding space in your account on [Builder.io](builder.io).
3. Connect the two.
4. Configure custom targeting attributes for locales in Builder.io.
...
2. Change into the example application by using the `cd` command:
   ...
   ```shell
   cd builder/examples/next-js-localized
   ```
...
4. When Builder asks you which ecommerce platform you use, select **None**.
...
Now that you have a configured Builder.io application, you can try different features, such as creating a page and localizing text.
