...
This example walks you through using Builder.io with a minimal React application.
...
1. Name your new space by entering "My React App" and click **Create**.
...
Now that you have a new space, the next step is connecting "My React App" with your application.
...
Then, set the Preview URL to http://localhost:5173. Be sure to include the http://.
...
In the [Account settings](https://builder.io/account/space), copy your Public API Key. We're going to paste the API Key into `YOUR_API_KEY` in `src/main.jsx`.
...
1. In your browser, go to `http://localhost:5173` to see your application.
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/git/external?repository-url=https%3A%2F%2Fgithub.com%2Fbuilderio%2Fbuilder%2Ftree%2Fmain%2Fexamples%2Freact-js)
