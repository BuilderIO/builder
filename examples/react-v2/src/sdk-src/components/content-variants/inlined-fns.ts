 ...
 */
function updateCookiesAndStyles(contentId: string, variants: VariantData[], isHydrationTarget: boolean) {
 ...
 * see our [SSR A/B Test Docs](https://github.com/BuilderIO/builder/tree/main/packages/sdks/src/SSR_AB_TEST.md)
 */
function updateVariantVisibility(variantContentId: string, defaultContentId: string, isHydrationTarget: boolean) {
...
export const UPDATE_COOKIES_AND_STYLES_SCRIPT = updateCookiesAndStyles.toString().replace(/\s+/g, ' ');
export const UPDATE_VARIANT_VISIBILITY_SCRIPT = updateVariantVisibility.toString().replace(/\s+/g, ' ')