# Remix + Builder.io Minimal Starter

This example walks you through using [Builder.io](https://builder.io) with a minimal [Remix](https://remix.run/) application.
...
1. Change into the example application by using the `cd` command:
   ...
   ```shell
   cd builder/examples/remix-minimal-starter
   ```
...
For this starter, your builder pages will show up under `http://localhost:3000/builder/<page url path>` since we created a 'builder' folder to make usage of the ['Splat' technique provided by Remix docs](https://remix.run/docs/en/v1/guides/routing) .
